...
var questions = [
	[
		"Menciona uno de los 9 pueblos de ecatepec ",
		"texalpa",
	...
	[
		"Vegetación que puedes encontrar en el desierto",
		"magueyes",
		"arbustos",
		"nopales",
		"sabila",
	...
	[
		"Dizfraz infantil mas comun en los festivales de primavera",
		"Mariposa",
		"Conejo",
		"Abejita",
		"Flor",
	...
	[
		"Ciudad mas famosa por su vida nocturna",
		"CDMX",
		"Nueva york",
		"Las vegas",
		"Ibiza",
	...
	[
		"Puestos que encuentras en la ciudad de Mexico",
		"De ropa",
		"De comida",
		"De pirateria",
		"Fayuca",
...
// Aquí utilizamos la libreria UnderscoreJS para generar una pantilla de pregunta.
...
//como el tiempo de respuesta de cada pregunta).
var points,
	pointsPerQuestion,
	currentQuestion,
	questionTimer,
	...
	function generateCards() {
		...
		for (var i = 0; i < questions.length; i++) {
			...
			$('.questions').append(html);
                ...
                // Indicamos que nos interesa el evento change de los inputs 
				//dentro de los elementos (cada una de las preguntas).
